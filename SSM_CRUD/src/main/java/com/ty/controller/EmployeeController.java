...
/**
* @Description: SSM的高级整合，结合bootstrap对员工的增、删、改、查操作；集成swagger1
...
public class EmployeeController {
	...
	* Modification History:
	...
	@ApiOperation(value="查询全部的员工",httpMethod="GET",notes="get all employees",response=Msg.class)
	...
	* @throws：异常描述
	...
	@ResponseBody
	@ApiOperation(value="保存一个员工",httpMethod="POST",notes="save one employees",response=Msg.class)
	...
	* Modification History:
	...
	@ResponseBody
	@ApiOperation(value="检测员工",httpMethod="GET",notes="cheack one employee",response=Msg.class)
	...
	* Modification History:
	...
	@ResponseBody
	@ApiOperation(value="根据ID获取员工信息",httpMethod="GET",notes="get one employee by id",response=Msg.class)
	...
	* Modification History:
	...
	@ResponseBody
	@ApiOperation(value="修改一个员工",httpMethod="PUT",notes="update one employee",response=Msg.class)
	...
	* Modification History:
	...
	@ResponseBody
	@ApiOperation(value="删除一个员工",httpMethod="DELETE",notes="delete one employee",response=Msg.class)
